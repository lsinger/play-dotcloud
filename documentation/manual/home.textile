...
p(note). In some cases, the application will not run after deployment, even though no errors occurred. Running "dotcloud logs myapp.www" in another terminal window resolves this issue. Dotcloud are currently investigating this issue. 
